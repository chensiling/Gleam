...
namespace GleeBug
{
    ...
    void Debugger::exceptionGuardPage(const EXCEPTION_RECORD & exceptionRecord, bool firstChance)
    {
        ...
        // exceptionAddress may or may not be inside one of our breakpoint ranges.
        char error[128] = "";
        ...
        // exceptionAddress is confirmed inside a known memory breakpoint range.
        ...
        //Multiple breakpoints per page are fine: enabled is a property of each range and ranges do not overlap.
        const auto info = foundInfo->second;
        ...
        // Access type matches this breakpoint range; safe to invoke callbacks.
