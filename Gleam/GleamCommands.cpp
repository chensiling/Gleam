...
void GleamDebugger::cmdHelp()
{
    printf(
        ...
        "  peb [env]               process environment block (flags, cmdline, env\n"
        "                          names; 'peb env' also prints env VALUES, which\n"
        "                          may include tokens/passwords)\n"
        "  teb [tid]               thread environment block (stack, LastError, TLS)\n"
        "  tls [tid]               TLS slots and implicit-TLS module array\n"
